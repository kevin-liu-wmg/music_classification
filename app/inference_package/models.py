...
from inference_package.pytorch_utils import do_mixup, interpolate, pad_framewise_output
...
class Conv_2d(nn.Module):
    def __init__(self, input_channels, output_channels, shape=3, pooling=2, dropput=0.1):
...
class CNN(nn.Module):
    def __init__(self, num_channels=16,
        ...
        # mel spectrogram
        self.melspec = torchaudio.transforms.MelSpectrogram(sample_rate=sample_rate, n_fft=n_fft,
    ...
    def forward(self, wav, mixup_lambda=None):
        # input preprocessing
        ...
        # reshape, (batch)size, num_channels, 1, 1) -> (batch_size, num_channels)
        ...
        output_dict = {'clipwise_output': out}
        return output_dict